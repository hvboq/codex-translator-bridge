...
Thank you for helping improve Codex Translator Bridge.

## Before opening an issue

- Search existing issues first.
- Reproduce the problem with the latest committed version.
- Use synthetic translation text whenever possible.
...
- Add or update tests for changed routes, model selection, cache behavior, batching, input validation, or placeholder handling.
